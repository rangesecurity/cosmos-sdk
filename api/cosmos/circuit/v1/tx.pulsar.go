...
var _ protoreflect.List = (*_MsgTripCircuitBreaker_4_list)(nil)

type _MsgTripCircuitBreaker_4_list struct {
	list *[]string
}

func (x *_MsgTripCircuitBreaker_4_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_MsgTripCircuitBreaker_4_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_MsgTripCircuitBreaker_4_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_MsgTripCircuitBreaker_4_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_MsgTripCircuitBreaker_4_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message MsgTripCircuitBreaker at list field BypassSet as it is not of Message kind"))
}

func (x *_MsgTripCircuitBreaker_4_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_MsgTripCircuitBreaker_4_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_MsgTripCircuitBreaker_4_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_MsgTripCircuitBreaker_bypass_set    protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgTripCircuitBreaker_bypass_set = md_MsgTripCircuitBreaker.Fields().ByName("bypass_set")
}
...
func (x *fastReflection_MsgTripCircuitBreaker) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.BypassSet) != 0 {
		value := protoreflect.ValueOfList(&_MsgTripCircuitBreaker_4_list{list: &x.BypassSet})
		if !f(fd_MsgTripCircuitBreaker_bypass_set, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgTripCircuitBreaker) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.bypass_set":
...
func (x *fastReflection_MsgTripCircuitBreaker) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.bypass_set":
		if len(x.BypassSet) == 0 {
			return protoreflect.ValueOfList(&_MsgTripCircuitBreaker_4_list{})
		}
		listValue := &_MsgTripCircuitBreaker_4_list{list: &x.BypassSet}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.circuit.v1.MsgTripCircuitBreaker"))
...
func (x *fastReflection_MsgTripCircuitBreaker) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.bypass_set":
		lv := value.List()
		clv := lv.(*_MsgTripCircuitBreaker_4_list)
...
func (x *fastReflection_MsgTripCircuitBreaker) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.bypass_set":
		...
		value := &_MsgTripCircuitBreaker_4_list{list: &x.BypassSet}
		return protoreflect.ValueOfList(value)
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.authority":
...
func (x *fastReflection_MsgTripCircuitBreaker) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.circuit.v1.MsgTripCircuitBreaker.bypass_set":
		list := []string{}
		return protoreflect.ValueOfList(&_MsgTripCircuitBreaker_4_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.circuit.v1.MsgTripCircuitBreaker"))
		}
...
type MsgTripCircuitBreaker struct {
	...
	// / allows caller to specify an extra set of addresses that can bypass the tripped circuit
	// / TODO: should this be constrained to users of a certain permission level?
	BypassSet []string `protobuf:"bytes,4,rep,name=bypass_set,json=bypassSet,proto3" json:"bypass_set,omitempty"`
}
...
func (x *MsgTripCircuitBreaker) GetBypassSet() []string {
	if x != nil {
		return x.BypassSet
	}
	return nil
...
var file_cosmos_circuit_v1_tx_proto_rawDesc = []byte{
	...
	0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xa7, 0x01, 0x0a, 0x15, 0x4d,
	...
	0x72, 0x65, 0x73, 0x41, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x79, 0x70, 0x61, 0x73, 0x73, 0x5f,
	0x73, 0x65, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x62, 0x79, 0x70, 0x61, 0x73,
	0x73, 0x53, 0x65, 0x74, 0x3a, 0x0e, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f,
	...
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0xf4, 0x02, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12,
	0x7f, 0x0a, 0x17, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x43, 0x69, 0x72, 0x63,
	0x75, 0x69, 0x74, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x12, 0x2d, 0x2e, 0x63, 0x6f, 0x73,
	...
	,
	...
	0x73, 0x65, 0x12, 0x73, 0x0a, 0x13, 0x52, 0x65, 0x73, 0x65, 0x74, 0x43, 0x69, 0x72, 0x63, 0x75,
	0x69, 0x74, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x12, 0x29, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x63, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x73,
	0x67, 0x52, 0x65, 0x73, 0x65, 0x74, 0x43, 0x69, 0x72, 0x63, 0x75, 0x69, 0x74, 0x42, 0x72, 0x65,
	0x61, 0x6b, 0x65, 0x72, 0x1a, 0x31, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x63, 0x69,
	...
	0x01, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x63, 0x69,
	0x72, 0x63, 0x75, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x07, 0x54, 0x78, 0x50, 0x72, 0x6f, 0x74,
